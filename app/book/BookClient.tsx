...
// Removed static emailjs import to reduce JS bundle size.
...
export default function BookClient() {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      // TBT FIX: Dynamically import EmailJS ONLY when the user clicks the button.
      // This saves ~45 KB of JavaScript from downloading/parsing on the initial page load.
